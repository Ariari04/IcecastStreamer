...
MP4Atom* MP4Atom::CreateAtom(const char* type)
{
  ...
  if (type == NULL) {
    ...
    case 0251:
      ...
      static const char cpy[5]={static_cast<char>(0251),'c', 'p', 'y', '\0'};
      static const char des[5]={static_cast<char>(0251),'d', 'e', 's','\0'};
      static const char prd[5]={static_cast<char>(0251), 'p', 'r', 'd', '\0'};
