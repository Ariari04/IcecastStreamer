...
BE_ERR	beInitStream(PBE_CONFIG pbeConfig, DWORD *pdwSamples, DWORD *pdwBufferSize, PHBE_STREAM phbeStream);
BE_ERR	beEncodeChunk(HBE_STREAM hbeStream, DWORD nSamples, SHORT *pSamples, BYTE *pOutput, DWORD *pdwOutput);

// added for floating point audio  -- DSPguru, jd
BE_ERR	beEncodeChunkFloatS16NI(HBE_STREAM hbeStream, DWORD nSamples, FLOAT *buffer_l, FLOAT *buffer_r, BYTE *pOutput, DWORD *pdwOutput);
